...
program.command('run')
    ...
    .option('-i --spreadsheet-id <string>', 'ID of Google Sheets spreadsheet to write output to (i.e. https://docs.google.com/spreadsheets/d/{ID}/edit)')
    ...
    .option('--add-header-row', 'Add the name of the columns to the first row of the spreadsheet ')
    .action(run)
